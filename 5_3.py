...
text1 = read_file("data/article1.txt")
text2 = read_file("data/article2.txt")

# Визначення підрядків для пошуку
existing_substring_start = "Анотація"
existing_substring_end = "Література"
...
if __name__ == '__main__':
    for i, text in enumerate([text1, text2]):
        print(f"\nСтаття №{i+1}")
        results = []
        for pattern in [existing_substring_start, existing_substring_end, fake_substring]:
